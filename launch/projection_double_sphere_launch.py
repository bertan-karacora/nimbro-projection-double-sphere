...
launch_args = [
    ...
    DeclareLaunchArgument("projection_slop_synchronizer", description="Maximum time disparity between associated image and pointcloud messages", default_value="0.05"),
